...
$(function(){
    ...
    $("#wrapper").append('<div id="inline1" style="width:400px;display: none;"><form novalidate="novalidate" class="formtastic admin_user" id="edit_admin_user" action="/admin/admin_users/'+x4+'"accept-charset="UTF-8" method="post"><input name="utf8" type="hidden" value="✓"><input type="hidden" name="_method" value="patch"><fieldset class="inputs"><legend><span>Nhập các thông tin</span></legend><ol><li class="password input optional stringish" id="admin_user_password_current_input"><label for="admin_user_password_current" class="label">Mật khẩu hiện tại</label><input id="admin_user_password_current" type="password" name="admin_user[password_current]" required="required"></li><li class="password input required stringish" id="admin_user_password_input"><label for="admin_user_password" class="label">Mật khẩu mới<abbr title="required">*</abbr></label><input maxlength="72" id="admin_user_password" type="password" name="admin_user[password]" required="required"></li><li class="password input optional stringish" id="admin_user_password_confirmation_input"><label for="admin_user_password_confirmation" class="label">Nhập lại mật khẩu mới</label><input id="admin_user_password_confirmation" type="password" name="admin_user[password_confirmation] required="required""></li></ol></fieldset><fieldset class="actions"><ol><li class="action input_action " id="admin_user_submit_action"><input type="submit" name="commit" value="Cập nhật mật khẩu"></li><li class="cancel"><a href="/admin/admin_users/'+x4+'">Cancel</a></li></ol></fieldset></form></div>');
    }
});